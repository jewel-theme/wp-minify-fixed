...
<?php
    ...
    printf('
      ...
      update[cache_interval]" type="text" size="4" value="'.esc_attr($wpm_options['cache_interval']).'"/>%s <span class="submit"><input type="submit" name="wpm_options_clear_cache_submit" value="%s"/></span></p></label>
      ',
